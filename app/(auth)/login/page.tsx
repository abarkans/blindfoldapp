    ...
    <div className="min-h-screen bg-[#0d0d14] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3 mb-8">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-pink-500 to-rose-600 flex items-center justify-center shadow-lg shadow-pink-500/40">
        ...
        <div className="bg-white/5 border border-white/10 rounded-3xl p-6 backdrop-blur-sm">
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center text-xs text-white/30">
              <span className="bg-[#0d0d14] px-3">or continue with</span>
            </div>
          </div>
