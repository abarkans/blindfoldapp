              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="bg-[rgb(var(--fg)/0.035)] border border-[rgb(var(--fg)/0.16)] rounded-2xl p-4">
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl bg-[rgb(var(--fg)/0.07)] flex items-center justify-center shrink-0">
                      <Mail className={`w-4 h-4 ${theme === "dark" ? "text-[#a6a6a6]" : "text-[#606060]"}`} />
                    </div>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="mt-2 rounded-2xl border border-[rgb(var(--fg)/0.16)] bg-[rgb(var(--fg)/0.04)] p-4">
                    <div className="mb-3 flex items-center gap-2">
                      <Mail className={`h-4 w-4 ${theme === "dark" ? "text-[#a6a6a6]" : "text-[#606060]"}`} />
                ...
                <div className="flex flex-col gap-3">
                  ...
                  {!isPlus && (
                    <div className="bg-gradient-to-br from-white/[0.045] to-white/[0.025] border border-rose-400/45 rounded-2xl p-5 flex flex-col gap-4">
                      ...
                      <div className="flex items-center gap-0.5 bg-[rgb(var(--fg)/0.05)] border border-[rgb(var(--fg)/0.16)] rounded-2xl p-1 w-full md:w-auto md:self-start">
                        <button
                          type="button"
                          onClick={() => setBillingInterval("monthly")}
                          className={`flex-1 md:flex-none px-5 py-2 rounded-xl text-sm font-semibold transition-all ${
                            billingInterval === "monthly"
                              ? "bg-[rgb(var(--fg)/0.15)] text-[rgb(var(--fg))] shadow"
                        ...
                        <button
                          ...
                          className={`flex-1 md:flex-none flex items-center justify-center gap-2 px-5 py-2 rounded-xl text-sm font-semibold transition-all ${
                            billingInterval === "yearly"
                              ? "bg-[rgb(var(--fg)/0.15)] text-[rgb(var(--fg))] shadow"
                              : "text-[rgb(var(--fg)/0.45)] hover:text-[rgb(var(--fg)/0.7)]"
                          }`}
