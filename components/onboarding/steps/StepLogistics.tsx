...
export default function StepLogistics({ defaultValues, onNext, continueTrigger, onCanContinueChange, unitSystem = "metric", planType }: StepLogisticsProps) {
  ...
  return (
    <div className="flex flex-col gap-7">
      ...
      {isTrial && (
        <div className="flex items-start gap-2.5 bg-blue-500/10 border border-blue-500/20 rounded-2xl px-4 py-3">
          <Info className="w-4 h-4 text-blue-400 shrink-0 mt-0.5" />
          <p className="text-sm text-blue-300 leading-relaxed">
            Your first date is a night out. You can change your budget, date place, and other
            preferences anytime from Settings.
          </p>
        </div>
      )}
