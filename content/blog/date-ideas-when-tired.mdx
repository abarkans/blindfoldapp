...
**Time-limit it.** "One hour, then we're home" creates safety for the lower-energy person. An escape hatch makes the yes easier. Often the time limit gets forgotten once you're out.

**Let the less-tired person plan completely.** No input required from the tired one. Just show up and follow along. Being cared for like that — having someone make the decisions and handle the logistics — is sometimes exactly what an exhausted person needs.

**Don't make it a negotiation.** Two tired people trying to agree on a plan while both being too tired to have opinions is a recipe for nothing happening. One person takes the lead. The other gets to rest and receive.
