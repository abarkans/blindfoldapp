...
Each of you cooks the same simple dish separately, without watching the other. Blind taste test, no coaching allowed during. Loser does the dishes. If sensory guessing games land for you, the [blindfold date guide](/blog/blindfold-date-ideas-ultimate-guide) runs entirely on taste, touch, and trust.
