...
The research on relationship satisfaction is fairly consistent: [shared novel experiences produce stronger connection than shared comfortable ones](https://www.apa.org/pubs/journals/releases/psp-pspi0000147.pdf). The effect is larger for long-term couples than for new ones — because novelty is naturally higher early on, and has to be deliberately created later.
