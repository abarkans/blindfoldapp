...
Anticipation is one of the strongest positive emotions available to humans — neurologically, the expectation of a reward activates the same dopamine pathways as the reward itself. A mystery date front-loads anticipation into the relationship without requiring a special occasion.
