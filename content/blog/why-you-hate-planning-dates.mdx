...
The single biggest reason people hate planning dates is not laziness — it is neuroscience. The average adult makes tens of thousands of small and large decisions in a single day. Every choice you make — from what to order for lunch to how to word that email — draws from the same finite cognitive battery.

That battery has a name: [decision fatigue](https://pmc.ncbi.nlm.nih.gov/articles/PMC12580165/), the tendency for decision quality to drop the more choices you've already made that day. The underlying theory, ego depletion, treats self-regulation as a limited resource — spend enough of it on small decisions, and the ones left over get made worse, or avoided entirely.
...
Novelty is [one of the core mechanisms through which date nights actually strengthen a relationship](/blog/why-couples-who-try-new-things). That means a pottery class, a neighbourhood you have never explored, or a [mystery date](/blog/mystery-date-ideas-for-couples) where neither of you knows the destination can outperform an expensive dinner at a restaurant you have been to a dozen times.
...
That same National Marriage Project survey found couples with regular date nights were far more likely to call their marriage "very happy" than those without — roughly 83-84% versus 68-70%. But that result compounds over time only if you reflect on what worked. After each date, take two minutes to note what landed well. This builds a personalised "date playbook" that makes future planning faster and more accurate.
...
A separate decade-long [Marriage Foundation study](https://marriagefoundation.org.uk/research/date-nights-strengthen-marriages/) tracking nearly 10,000 UK couples found that those who went out about once a month had notably lower odds of splitting up than couples who rarely went out — and, in a counterintuitive twist, also lower odds than couples who went out every week. Once a month seems to be the sweet spot, not "more is always better." If monthly feels like too much pressure given your budget or schedule, start bi-monthly and build from there.
